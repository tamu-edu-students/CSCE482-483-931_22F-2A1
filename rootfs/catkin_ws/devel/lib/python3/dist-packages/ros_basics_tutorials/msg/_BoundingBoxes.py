...
"""autogenerated by genpy from ros_basics_tutorials/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','ros_basics_tutorials/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ros_basics_tutorials.msg.BoundingBox()
        _x = val1
        start = end
        end += 42
