...
(cl:defmethod cl:initialize-instance :after ((m <ObjectCount>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectCount)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_basics_tutorials-msg:<ObjectCount> is deprecated: use ros_basics_tutorials-msg:ObjectCount instead.")))
...
(cl:defmethod count-val ((m <ObjectCount>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_basics_tutorials-msg:count-val is deprecated.  Use ros_basics_tutorials-msg:count instead.")
  (count m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ObjectCount>)))
  ...
  "ros_basics_tutorials/ObjectCount")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ObjectCount)))
  "Returns string type for a message object of type 'ObjectCount"
  "ros_basics_tutorials/ObjectCount")
